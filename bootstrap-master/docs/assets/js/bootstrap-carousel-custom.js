...
/*BEGIN set up the slider buttons*/
...
$('.carousel-caption h1').each(function() {
	...
	//alert("count: " + t);
	if(captionCount==1){
		$('#bottomCaption').append('<div id="caption_'+captionCount+'" class="bCaption"><h1>'+t+'</h1></div>');
	}else{
		$('#bottomCaption').append('<div id="caption_'+captionCount+'" class="bCaption hideDiv"><h1>'+t+'</h1></div>');
...
for(var i=1;i<count+1;i++){
	...
	if(i==1){
		$('#sliderButtons').append('<div id="button_'+i+'" class="sButton active"></div>');
	}else{
		$('#sliderButtons').append('<div id="button_'+i+'" class="sButton"></div>');
	}
